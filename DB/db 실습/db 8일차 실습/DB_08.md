...
```python
for movies in Movie.objects.all():
...
```python
for movies in Movie.objects.all().order_by('-opening_date'):
    print(movies.director.name,
        movies.title,
        movies.opening_date,
        movies.running_time,
...
movies=Movie.objects.filter(director=b_id).order_by('opening_date')[1]
print(movies.director.name,
        movies.genre.title, 
        movies.title,
        movies.opening_date, 
...
```python
for movies in Movie.objects.all().order_by('running_time'):
    if movies.running_time>119:
        print(movies.director.name,
            movies.genre.title,
            movies.title,
            movies.opening_date,
...
```python
for moives in Movie.objects.filter(opening_date__gte="2022-01-01").order_by('opening_date'):
        print(moives.director.name,
            moives.genre.title, 
            moives.title,
            moives.opening_date, 
            moives.running_time,
...
for movies in Movie.objects.filter(director=b_id,genre=drama_id).order_by('opening_date'):
            print(movies.director.name,
            movies.genre.title, 
            movies.title,
            movies.opening_date, 
...
```python
b_id=Director.objects.get(name="봉준호").id
for movies in Movie.objects.exclude(director=b_id).order_by('opening_date'):
            print(movies.director.name,
            movies.genre.title, 
            movies.title,
            movies.opening_date, 
